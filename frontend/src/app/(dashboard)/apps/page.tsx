  ...
  return (
    <div className="p-6 max-w-5xl mx-auto animate-fade-in">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        <Link href="/apps/football" className="block group">
           <div className="border border-[var(--border)] bg-[var(--card)] rounded-2xl p-6 hover:border-[var(--accent)] hover:shadow-md transition-all h-full bg-gradient-to-br from-[var(--card)] to-[var(--card-hover)]">
             <div className="w-14 h-14 bg-green-500/15 text-green-500 rounded-2xl flex items-center justify-center text-3xl mb-5 group-hover:scale-110 transition-transform shadow-sm">
               ⚽
             </div>
             ...
             <p className="text-[var(--muted)] text-sm leading-relaxed">
               Следите за live-результатами матчей Английской и Российской премьер-лиг без перехода на другие сайты.
             </p>
           </div>
        </Link>
      </div>

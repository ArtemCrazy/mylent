...
export default function DigestViewPage() {
  ...
  const backHref = digest.config_id ? `/digests/${digest.config_id}` : "/digests";

  return (
    <div className="p-6 max-w-3xl mx-auto">
      <Link href={backHref} className="text-sm text-[var(--muted)] hover:text-[var(--accent)] mb-4 inline-block">
        ← {digest.config_name ? `К «${digest.config_name}»` : "К дайджестам"}
      </Link>
